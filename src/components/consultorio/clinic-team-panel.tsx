  ...
  return (
    <div className="space-y-8">
      <div className="flex flex-wrap items-end justify-between gap-4">
        <div><p className="text-[11px] font-bold uppercase tracking-[0.16em] text-teal">Pessoas e acessos</p><h2 className="mt-1 font-heading text-[28px] font-normal text-foreground">Equipe da clínica</h2><p className="mt-1 text-sm text-muted-foreground">Papéis claros, acesso individual e convite pessoal por e-mail.</p></div>
