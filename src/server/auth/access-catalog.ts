...
export const ACCESS_CATALOG = {
  ...
  'clinico.revisar_tecnicamente': CLINIC_ONLY_SCOPES,
  'prontuario.exportar': CLINIC_ONLY_SCOPES,
  ...
  'governanca.gerir': CLINIC_ONLY_SCOPES,
  'configuracoes.gerir': CLINIC_ONLY_SCOPES,
  'auditoria.ler': CLINIC_ONLY_SCOPES,
  'estoque.ler': ALL_SCOPES,
  'estoque.gerir': ALL_SCOPES,
  'estoque.receber': ALL_SCOPES,
  'estoque.consumir': ALL_SCOPES,
  'estoque.descartar': ALL_SCOPES,
